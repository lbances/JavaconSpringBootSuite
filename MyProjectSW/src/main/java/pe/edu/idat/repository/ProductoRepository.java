...
public class ProductoRepository {
    ...
    public Producto insert(Producto producto) {        
        Long id_producto= Long.valueOf(DBProductos.size()+1);
        producto.setId_producto(id_producto);
        DBProductos.put(id_producto, producto);
        return producto;
    }
    
    public Producto update(Producto producto) {
    	DBProductos.put(producto.getId_producto(), producto);
    	return producto;
    }
    
    public void delete(Long id_producto) {
    	DBProductos.remove(id_producto);
    }
