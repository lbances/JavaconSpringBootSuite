...
public class PuntosAcceso {
	...
	public GuardarProductoResponse GuardarProducto(@RequestPayload GuardarProductoRequest peticion) {
		...
		CProducto cproducto=new CProducto(peticion.getCodpro(),peticion.getCodcat(),
				peticion.getDespro(),peticion.getUnipro(),peticion.getPcopro(),
				peticion.getPvepro(),peticion.getStopro(),peticion.getFrepro());
